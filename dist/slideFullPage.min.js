...
/* harmony export (immutable) */ __webpack_exports__["b"] = isDom;
...
function on(el, eventName, handle) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_event__ = __webpack_require__(1);
...
const methods = {
    ...
    initEvent: function initEvent() {
        ...
        if (this.options.isPc) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__src_event__["a" /* on */])(document, 'DOMMouseScroll', __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.throttle(methods.wheelFunc.bind(this), 700));
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__src_event__["a" /* on */])(document, 'mousewheel', __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.throttle(methods.wheelFunc.bind(this), 700));
        }

        // 移动端滑动事件
        if (this.options.isMobile) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__src_event__["a" /* on */])(document, 'touchstart', __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.throttle(methods.touchStart.bind(this), 700));
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__src_event__["a" /* on */])(document, 'touchmove', __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.throttle(methods.touchMove.bind(this), 700));
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__src_event__["a" /* on */])(document, 'touchend', __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.throttle(methods.touchEnd.bind(this), 700));
        }
    },
...
function SlideFullPage(options = {}) {
    ...
    // 初始化this
    this.container = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__src_event__["b" /* isDom */])(this.options.containerEl) ? this.options.containerEl : document.querySelector(this.options.containerEl);
    this.sections = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__src_event__["b" /* isDom */])(this.options.sectionEl) ? this.options.sectionEl : this.container.querySelectorAll(this.options.sectionEl);
...
/* harmony default export */ __webpack_exports__["default"] = (SlideFullPage);
